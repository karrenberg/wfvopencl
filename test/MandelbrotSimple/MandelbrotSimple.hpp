...
#ifndef MANDELBROTSIMPLE_H_
#define MANDELBROTSIMPLE_H_
...
class MandelbrotSimple : public SDKSample
{
...
public:
     ...
     * Run OpenCL MandelbrotSimple Sample
     */
    int run();
