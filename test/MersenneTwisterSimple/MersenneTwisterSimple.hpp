...
class MersenneTwisterSimple : public SDKSample
{
...
public:
	 ...
	 */
	MersenneTwisterSimple(std::string name)
		: SDKSample(name),
        blockSizeX(1),
        blockSizeY(1),
        setupTime(0),
        kernelTime(0)
    {
        numRands = GROUP_SIZE * GROUP_SIZE * 4;
        mulFactor = 2;
        seeds = NULL;
        deviceResult = NULL;
        devices = NULL;
	 ...
	 */
	MersenneTwisterSimple(const char* name)
		: SDKSample(name),
        blockSizeX(1),
        blockSizeY(1),
        setupTime(0),
	 ...
	 */
	int setupMersenneTwisterSimple();
