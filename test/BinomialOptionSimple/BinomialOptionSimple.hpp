 ...
 * Class implements OpenCL  BinomialOptionSimple sample
 * Derived from SDKSample base class
 */

class BinomialOptionSimple : public SDKSample
{
...
public:
     ...
     */
    explicit BinomialOptionSimple(std::string name)
        : SDKSample(name),
          setupTime(0),
          kernelTime(0),
          randArray(NULL),
     ...
     */
    explicit BinomialOptionSimple(const char* name)
        : SDKSample(name),
          setupTime(0),
          kernelTime(0),
          randArray(NULL),
     ...
     * Run OpenCL BinomialOptionSimple
     * @return 1 on success and 0 on failure
     */
    int run();
