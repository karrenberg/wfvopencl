...
MonteCarloAsian::setupMonteCarloAsian()
{
    ...
    if(!quiet) 
    {
        sampleCommon->printArray<cl_float>("sigma values", 
                                           sigma, 
                                           steps, 
                                           1);
    }
...
MonteCarloAsian::genBinaryImage()
{
    ...
    kernelPath.append("MonteCarloAsian_Kernels.cl");
...
MonteCarloAsian::printStats()
{
    ...
    this->SDKSample::logStats(strArray, stats, 4, "MonteCarloAsian", vendorName);
}
