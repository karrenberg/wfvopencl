...
#ifndef TESTDYNCHECKSPEED_H_
#define TESTDYNCHECKSPEED_H_
...
namespace dct
{
    ...
    */
    ...
    class TestDynCheckSpeed : public SDKSample
    {
        ...
        cl_int     *verificationOutput;    /**< Input array for reference implementation */
	...
	std::string vendorName;
         ...
         */
        TestDynCheckSpeed(std::string name)
            : SDKSample(name)    {
                seed = 123;
                input = NULL;
         ...
         */
        TestDynCheckSpeed(const char* name)
            : SDKSample(name)    {
                seed = 123;
                input = NULL;
                verificationOutput = NULL;
         ...
         */
        void TestDynCheckSpeedCPUReference( cl_int * output,
                          const cl_int * input ,
