...
/**
* NBodySimple 
* Class implements OpenCL  NBodySimple sample
* Derived from SDKSample base class
*/

class NBodySimple : public SDKSample
{
...
public:
    ...
    */
    explicit NBodySimple(std::string name)
        : SDKSample(name),
        setupTime(0),
        kernelTime(0),
        delT(0.005f),
    ...
    */
    explicit NBodySimple(const char* name)
        : SDKSample(name),
        setupTime(0),
        kernelTime(0),
        delT(0.005f),
